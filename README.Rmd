...
| ----- | ----------- | ------- | ---- |
| BSO | @Jakoby2019 | *Ips typographus* | `?model.bso.apply` <br/> `?model.bso.customize` |
| Lange | @Lange2006 | *Ips typographus* | `?model.lange.apply` <br/> `?model.lange.customize` |
| Jönsson | @Jonsson2011 | *Ips typographus* | `?model.joensson.apply` <br/> `?model.joensson.customize` |
| PHENIPS | @Baier2007 | *Ips typographus* | `?model.phenips.apply` <br/> `?model.phenips.customize` |
| PHENIPS&#x2011;Clim | - | *Ips typographus* | `?model.phenips_clim.apply` <br/> `?model.phenips_clim.customize` |
| RITY | @Ogris2019 | *Ips typographus* | `?model.rity.apply` <br/> `?model.rity.customize` |
| CHAPY | @Ogris2020 | *Pityogenes chalcographus* | `?model.chapy.apply` <br/> `?model.chapy.customize` |
...
```{r generations-plot, message=FALSE, warning = FALSE, out.width = "100%", fig.dim=c(7,2), out.width = "100%", fig.cap = "Generations plot"}
...
plotted for bith phenology variants.
