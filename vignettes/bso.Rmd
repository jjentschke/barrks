...
#> Error in (function (x, y = NULL, legend, fill = NULL, col = par("col"), : argument "legend" is missing, with no default
```

<div class="figure">
<img src="figures/bso-stage-diagram-1.png" alt="BSO stage diagram (generation '0' represents the hibernating beetles)" width="100%" />
...
<div class="figure">
<img src="figures/bso-gens-1.png" alt="Generations calculated by the BSO model" width="100%" />
