...
The BSO model works structurally differently than the other models in this package. It
...
``` r
bso_plot_stage_diagram(pheno_bso, 234)
```

<div class="figure">
<img src="figure/bso-stage-diagram-1.png" alt="BSO stage diagram (generation '0' represents the hibernating beetles)" width="100%" />
<p class="caption">BSO stage diagram (generation '0' represents the hibernating beetles)</p>
</div>
...
``` r
bso_plot_flight_diagram(pheno_bso, 234)
```

<div class="figure">
<img src="figure/bso-flight-diagram-1.png" alt="BSO flight diagram (the colors describe which generation flies to establish a new filial generation or a sister brood respectively)" width="100%" />
...
<div class="figure">
<img src="figure/bso-gens-1.png" alt="Generations calculated by the BSO model" width="100%" />
